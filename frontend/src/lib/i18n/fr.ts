...
export const fr = {
  ...
  home: {
    ...
    storage: 'Stockage',
    datasets: 'Datasets',
    storagePartial: "{volume} mesurés sur {measured} d'entre eux. {regulated} datasets de santé ne sont pas mesurés : le volume réel est plus élevé.",
    storageUnreadable: "{volume} mesurés sur {measured}. {unreadable} n'a pas pu être lu : à réparer, le total est faux en attendant.",
    storageTruncated: 'Mesure interrompue avant la fin : le volume réel est plus élevé.',
    storageHint: 'Déclarés sur la plateforme',
    storageMeasured: '{volume} au total.',
