...
export const fr = {
  ...
  nav: {
    ...
    ontologies: 'Catalogues de contenu',
  ...
  ontologies: {
    title: 'Catalogues de contenu',
    subtitle: 'Ce que contient un dataset : études, sujets, visites, modalités et volumes, déduits des chemins de ses objets.',
    empty: 'Aucun catalogue',
    emptyHint: 'Un catalogue lit les chemins des objets d’un dataset — jamais leur contenu — et en déduit ce qu’il contient : combien de sujets, quelles modalités, quelles visites. De quoi savoir ce qu’il y a dans un bucket de 40 000 fichiers sans en lister un seul.',
    scan: 'Analyser la source',
    scanning: 'Analyse en cours',
    query: 'Filtrer',
    queryLabel: 'Filtre',
    queryHint: 'Filtrez les objets du catalogue par sujet, visite ou modalité.',
    queryPlaceholder: 'ANTERION',
    source: 'Source',
    profile: 'Profil d’inférence',
    manifest: 'Manifeste',
    deleteTitle: 'Supprimer le catalogue',
    deleteWarning: 'Les projets rattachés perdront l’accès à ce catalogue.',
  },
