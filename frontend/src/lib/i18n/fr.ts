...
export const fr = {
  ...
  home: {
    ...
    storageUnreadable: "Mesuré sur {measured} datasets des {total}. Les datasets de santé ne sont pas comptés, et {unreadable} n'a pas pu être lu : le total est donc incomplet.",
