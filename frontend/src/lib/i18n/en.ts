...
export const en: Translations = {
  ...
  home: {
    ...
    storageUnreadable: 'Measured across {measured} of {total} datasets. Health datasets are not counted, and {unreadable} could not be read, so the total is incomplete.',
