...
export const en: Translations = {
  ...
  home: {
    ...
    storage: 'Storage',
    datasets: 'Datasets',
    storagePartial: '{volume} measured across {measured} of them. {regulated} health datasets are not measured, so the real volume is higher.',
    storageUnreadable: '{volume} measured across {measured}. {unreadable} could not be read: until that is fixed the total is wrong.',
    ...
    storageMeasured: '{volume} in total.',
