...
export const en: Translations = {
  ...
  agents: {
    ...
    recruit: 'Hire',
    recruitFirst: 'Hire my first agent',
    recruitTitle: 'Hire an agent',
    editTitle: 'Edit the agent',
    recruitIntro: 'Give them a name and say what you expect, the way you would to somebody starting.',
    nameLabel: 'Their name',
    namePlaceholder: 'Clemence',
    missionLabel: 'Their assignment',
    missionHelp:
      'Write it in plain language. Nothing here is a keyword: the assignment is passed on as written.',
    missionPlaceholder:
      'Watch my workspaces. When one will not start, tell me which and why, in one sentence.',
    examplesTitle: 'For example:',
    exampleWorkspaces:
      'Watch my workspaces. When one will not start, tell me which and why, in one sentence.',
    exampleApps: 'Check my applications. If one has stopped, restart it and tell me.',
    exampleQuiet: 'Once a day, go round my projects and tell me what changed.',
    scheduleLabel: 'Their hours',
    scheduleManual: 'On demand',
    scheduleHourly: 'Every hour',
    scheduleDaily: 'Once a day',
    mayRestartLabel: 'They may restart a stopped application',
    mayRestartHelp:
      'Without this they look and report, and change nothing. It is the only thing an agent can change, and every restart is recorded.',
    mayRestart: 'May restart an application',
    readsOnly: 'Looks and reports',
    hire: 'Hire',
    hired: '{name} has started.',
    updated: 'Updated.',
    teamsTitle: 'Teams',
    teamsIntro:
      'Several agents on one subject. You write down in advance who may ask whom for what, and nothing else happens.',
    teamsEmpty:
      'Your agents each work on their own. A team gives them a shared subject and lets you write what they may ask of each other.',
    formTeam: 'Form a team',
    formFirstTeam: 'Form my first team',
    formTeamTitle: 'Form a team',
    formTeamIntro: 'Give it a name and say what it works on.',
    teamNameLabel: 'Its name',
    teamNamePlaceholder: 'On call',
    teamPurposeLabel: 'Its subject',
    teamPurposePlaceholder: 'Keep the production applications running overnight.',
    teamFormed: 'The {name} team is formed.',
    teamMembers: 'Who is in it',
    teamNoMembers: 'Nobody yet. Put an agent in this team from its own card.',
    organisation: 'Who may ask for what',
    organisationHelp:
      'A line that is saved is a line that works: if the ask could never succeed, it is refused straight away with its reason.',
    organisationEmpty:
      'Nobody may ask anybody for anything yet. A lead may ask a member to act, once you have written it here.',
    mandateSentence: '{lead} may ask {member} to {action}.',
    askActionRestartApp: 'restart a stopped application',
    allowAsk: 'Allow an ask',
    allowAskTitle: 'Allow an ask',
    allowAskIntro:
      'Choose who asks and whom. This grants no new right: it only says who may ask for it.',
    askLeadLabel: 'Who asks',
    askMemberLabel: 'Whom',
    askActionLabel: 'To do what',
    askWritten: 'Written down.',
    withdraw: 'Withdraw',
    withdrawn: 'Withdrawn.',
    needsALead: 'The team needs at least one lead. An agent becomes a lead from its own card.',
    roleObserver: 'Looks and reports',
    roleOperator: 'May act',
    roleLead: 'Lead',
    ...
    daysAgo: '{count} d ago',
    whatTheySaw: 'What {name} saw',
    nothingToReport: 'Nothing to report',
    reported: 'They have something to say.',
    failed: 'Failed',
    loadingRuns: 'Reading the journal…',
    neverRan: 'They have not worked yet. Run them now, or wait for their hours.',
    emptyLead:
      'You have not hired anybody yet. An agent is somebody you leave a standing instruction with, written as you would say it:',
    actionRestartApp: 'Application restarted',
  },
  aiServices: {
    title: 'AI services',
    full: 'Full service',
  ...
  home: {
    ...
    storage: 'Storage',
    storagePartial: 'Across {measured} datasets. {pending} not measured yet, so the real volume is higher.',
    storagePending: 'Not measured yet - the first sweep runs tonight.',
    storageAsOf: 'Across all {count} datasets, measured {when}.',
    storageUnreadable: 'Across {measured} datasets. {unreadable} could not be read: until that is fixed this total is short.',
    storageHint: 'Registered on the platform',
  ...
  workspaces: {
    ...
    startupTechnical: 'Technical detail',
    step_requested: 'Request recorded',
    step_scheduled: 'Machine reserved',
    step_image: 'Environment fetched',
    step_storage: 'Data attached',
    step_environment: 'Preparing the session',
    reason_no_capacity: 'No machine can take this size at the moment.',
    reason_image_unavailable: 'The environment image could not be fetched.',
  ...
  apis: {
    title: 'APIs',
    subtitle: 'Endpoints deployed from your projects, called by other applications.',
    create: 'Deploy an API',
    empty: 'No API deployed',
    emptyHint: 'An API is the same workload as an application, but nobody opens it in a browser: the platform shows a call example rather than a preview.',
    callTitle: 'Call this API',
    callHint: 'The address, snippets ready to paste, and a token that belongs to the project — it outlives whoever created it.',
    endpoint: 'Address',
    tokenName: 'Token name',
    tokenNameHint: 'The name is how you revoke the right one without guessing: "scoring-prod" beats "token 3".',
    tokenCreate: 'Create a token',
    tokenRevoke: 'Revoke',
    tokenOnce: 'This token is shown once and cannot be recovered. Copy it now.',
    tokenLastUsed: 'used {when}',
  ...
  environments: {
    ...
    building: 'Building',
    revisions: 'Revisions',
    deleteRevision: 'Delete this revision',
    deleteRevisionHint: 'Removes {image} from this environment\u2019s history. The image itself stays in the registry.',
    revisionDeleted: 'Revision deleted',
    systemRebuildHint: 'This environment is the one the platform is configured to run. Rebuilding it would push into the platform\u2019s own repository, which it will not start - build under a name of your own instead.',
    revisionsHint: 'Each build produces a usable revision.',
    vulnerabilities: 'Vulnerabilities',
    noVulnerabilities: 'None',
    notScanned: 'Not scanned',
    scanUnavailable: 'Unknown',
    provenance: 'Source',
  ...
  datasets: {
    ...
    renameHint: 'The file stays in this folder. The copy is verified before the old name is removed, so a failure leaves both names rather than neither.',
    ...
    replaceCredentialsHint: 'Tried against the bucket before being saved. Credentials that cannot reach it are refused and the current ones stay in place.',
    accessKey: 'Access key',
    secretKey: 'Secret key',
    credentialsReplaced: 'Credentials replaced',
    ownershipHint: 'The owner administers the dataset and its permissions. An organization outlives the person who created it.',
  ...
  ontologies: {
    ...
    scanNoDataset: 'No dataset attached to this project. Attach one from the project\u2019s Data tab.',
    scanProfileHint: 'health-file-path-v1 recognises <subject>/<visit>/<modality>: a subject such as PREMYOM1000-001, a visit as YYYYMMDD (a visit_ prefix is accepted), the modality right after. Anything that does not follow that shape is counted and described, never guessed.',
    ...
    noMatch: 'No object matches this filter.',
    unrecognised: 'Unreadable paths',
    unrecognisedHint: 'Objects whose path does not follow the convention this profile knows. Their shape is shown so you can judge: {shapes}',
    queryPlaceholder: 'ANTERION',
    source: 'Source',
    profile: 'Inference profile',
    manifest: 'Manifest',
    completeness: 'Coverage',
    completenessHint: 'How many subjects carry each modality, and which ones do not. A cohort asked for by modality silently excludes the latter.',
    completenessSubjects: '{complete} of {total} subjects carry every modality in the study.',
    ...
    cohortFiles: '{count} files',
    cohortEmpty: 'No cohort for this ontology.',
    cohortCreated: 'Cohort frozen over {count} files.',
    cohortDeleteTitle: 'Delete the cohort',
    cohortDeleteWarning: 'The frozen selection is lost. The dataset files are untouched.',
    cohortMountHint: 'Mounted in the project workspaces under /mnt/cohorts/<name>/<subject>/<visit>/<modality>.',
    freshness: 'Freshness',
    freshnessMeasured: 'Measured {days} days ago, over {objects} objects.',
    freshnessMeasuredToday: 'Measured today, over {objects} objects.',
    freshnessAligned: 'The source still holds the same number of objects.',
    freshnessGrown: 'The source holds {drift} more objects since this measurement.',
    freshnessShrunk: 'The source holds {drift} fewer objects since this measurement.',
  ...
  secrets: {
    ...
    kindLabel: 'Kind of secret',
    kindHint: 'A token has a lifetime decided elsewhere; the platform warns before it expires, provided it knows the date.',
    kindGeneric: 'Any value',
    kindPersonalToken: 'Personal access token',
    kindRepositoryToken: 'Repository access token',
    expiresRequiredHint: 'GitHub and GitLab both cap their tokens at a year.',
    neverExpires: 'This token does not expire',
    expiryAnswerRequired: 'Give the expiry date, or tick that the token does not expire.',
  ...
  members: {
    orgTitle: 'Organization access',
    orgHint: 'Every member of the organization holds this role on the project. Access adds up: the stronger of a personal role and one inherited from an organization applies.',
    orgEmpty: 'No organization has access to this project.',
    orgLabel: 'Organization',
    orgPlaceholder: 'Choose an organization',
    orgGrant: 'Grant',
    orgGranted: 'Access granted to the organization.',
    title: 'Members',
  ...
  people: {
    ...
    newOrganizationHint: 'An organisation lives in the directory: it is created here and not deleted here.',
    organizationCreated: 'Organisation created',
    alias: 'Alias',
    organizationSummary: '{people} person(s), {teams} team(s)',
    newTeam: 'New team',
    addToOrganization: 'Add to organisation',
    removeFromOrganization: 'Remove from organisation',
    teamSummary: '{count} member(s)',
    teamRenamed: 'Team renamed',
    teamRemoveWarning: 'Delete team {name}? Its {count} member(s) lose the access it gave them, and its project grants go with it.',
    teamRemoveHint: "{count} member(s) affected. The team's project grants are removed with it.",
    unaffiliated: 'No organisation',
    unaffiliatedHint: 'Accounts that belong to no organisation - typically service accounts, or people not attached yet.',
    nobody: 'Nobody.',
  ...
  admin: {
    ...
    deactivateSecrets: 'Personal secrets are not transferred: they belong to the person, not to the role.',
    deactivatedHint: 'Account disabled, {count} token(s) revoked',
    reactivate: 'Re-enable',
    ownedTitle: 'What this account owns',
    ownsNothing: 'This account owns nothing personally: there is nothing to hand on.',
    ownedProjects: 'Projects:',
    ownedDatasets: 'Datasets:',
    ownedOntologies: 'Ontologies:',
    ownedApps: 'Apps:',
    ownedDatasources: 'Data sources:',
    ownedRepositories: 'Repositories:',
    successorLabel: 'Successor',
    successorHint: 'Receives ownership of everything above, in the same operation.',
    smtp: 'Mail server',
    smtpHint: 'Used to send invitation and reset links. Filled in per installation: each site sends through its own relay.',
    smtpConfigured: 'Configured',
    smtpMissing: 'Not set',
    smtpHost: 'Host',
    smtpPort: 'Port',
    smtpFrom: 'Sender address',
    smtpFromHint: 'What the recipient sees. The relay must accept this address.',
    smtpFromName: 'Display name',
    smtpReplyTo: 'Reply to',
    smtpUser: 'Username',
    smtpPassword: 'Password',
    smtpPasswordHint: 'Write-only: it is never sent back to a browser.',
    smtpPasswordStored: 'A password is stored. Leave empty to keep it.',
    smtpNoAuthHint: 'Authentication is off: the relay accepts mail without credentials.',
    smtpAuth: 'Authentication',
    smtpTest: 'Send a test',
    smtpTestTo: 'Test recipient',
    ...
    activity: 'Activity',
    activityHint: 'Who used the platform, doing what. Counted from what the platform recorded, not from what anyone remembers.',
    activityEmpty: 'Nothing recorded over this period.',
    activityCoverage: 'Records begin on {since}; the period before that is not quiet, it is unrecorded.',
    byOrganization: 'By organisation',
    noOrganization: 'No organisation',
    activePeoplePerDay: 'People active per day',
    whoWasActive: '{count} people active',
    whatWasDone: 'What was done',
    peopleCount: '{count} people',
    eventsCount: '{count} actions',
    actionsTruncated: 'Showing the {shown} most frequent of {total} kinds of action.',
    ...
    teamUsage: 'Consumption by team',
    teamUsageHint: 'Over the last 30 days. Consumption is sampled per project, so a team figure is an attribution rather than a measurement.',
    teamUsageEmpty: 'No usage report available.',
    teamUsageNoTeams: 'No team reaches a project yet, so everything is unattributed.',
    teamUsagePlatform: 'Platform (vCPU·h)',
    teamUsagePlatformHint: 'What the cluster actually consumed.',
    teamUsageAttributed: 'Attributed (vCPU·h)',
    teamUsageAttributedHint: 'The sum of the rows below.',
    teamUsageOverlap: 'Exceeds the platform by {excess} because teams share projects.',
    teamUsageUnattributed: 'Unattributed (vCPU·h)',
    teamUsageUnattributedHint: 'Reached by no team - held personally or by an organization.',
    teamUsageMembers: 'Members',
    teamUsageProjects: 'Projects',
    teamUsageVcpuHours: 'vCPU·h',
    teamUsagePeak: 'Peak vCPU',
    teamUsageShared: '{count} shared',
    teams: 'Teams',
    teamsHint: 'Groups of people inside an organization. What a team may reach is granted from the project, not here.',
    teamsPickOrganization: 'Pick an organization to see its teams.',
    teamsEmpty: 'No team yet in this organization.',
    teamNamePlaceholder: 'P&C, Claims, Data Science…',
    teamName: 'Team name',
    teamAdd: 'Add team',
    teamCreated: 'Team created',
    teamRemove: 'Delete team',
    teamRemoved: 'Team deleted',
