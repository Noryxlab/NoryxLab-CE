...
func NewServer(cfg config.Config, h handlers.Handlers) *http.Server {
	...
	mux.HandleFunc("POST /api/v1/egress/rules", h.CreateEgressRule)
	...
	mux.HandleFunc("GET /api/v1/admin/backups/runs", h.ListAdminBackupRuns)
	mux.HandleFunc("POST /api/v1/admin/backups/runs", h.CreateAdminBackupRun)
	mux.HandleFunc("GET /api/v1/admin/backups/runs/{runID}/report", h.GetAdminBackupRunReport)
