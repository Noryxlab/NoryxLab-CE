...
func NewServer(cfg config.Config, h handlers.Handlers) *http.Server {
	...
	mux.HandleFunc("GET /api/v1/user/teams", h.ListMyTeams)
	...
	mux.HandleFunc("PUT /api/v1/datasets/{datasetID}/credentials", h.UpdateDatasetCredentials)
	...
	mux.HandleFunc("DELETE /api/v1/admin/users/{userID}", h.DeleteUserAccount)
	...
	mux.HandleFunc("GET /api/v1/projects/{projectID}/team-roles", h.ListProjectTeamRoles)
	mux.HandleFunc("PUT /api/v1/projects/{projectID}/team-roles/{teamID}", h.SetProjectTeamRole)
	mux.HandleFunc("DELETE /api/v1/projects/{projectID}/team-roles/{teamID}", h.DeleteProjectTeamRole)
	...
	mux.HandleFunc("GET /api/v1/admin/activity", h.GetActivityReport)
	...
	mux.HandleFunc("GET /api/v1/admin/organizations/{organizationID}/teams", h.ListTeams)
	mux.HandleFunc("POST /api/v1/admin/organizations/{organizationID}/teams", h.CreateTeam)
	mux.HandleFunc("PUT /api/v1/admin/teams/{teamID}", h.UpdateTeam)
	mux.HandleFunc("DELETE /api/v1/admin/teams/{teamID}", h.DeleteTeam)
	mux.HandleFunc("GET /api/v1/admin/teams/{teamID}/members", h.ListTeamMembers)
	mux.HandleFunc("POST /api/v1/admin/teams/{teamID}/members", h.AddTeamMember)
	mux.HandleFunc("DELETE /api/v1/admin/teams/{teamID}/members/{userID}", h.RemoveTeamMember)
