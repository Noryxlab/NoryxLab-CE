...
- Jupyter base image: `harbor.example.local/noryx-environments/noryx-jupyter:0.1.0`
- VSCode base image: `harbor.example.local/noryx-environments/noryx-vscode:0.1.0`
- RStudio base image: `harbor.example.local/noryx-environments/noryx-rstudio:0.1.0`
...
curl -sk -X POST "$BASE/api/v1/builds" \
  ...
  -d '{
    ...
    "destinationImage":"harbor.example.local/noryx-environments/hello-world:test1"
  }'
