...
- `harbor.example.local/noryx-environments/noryx-workspace-vscode:0.1.0`
...
- `destinationImage`: `harbor.example.local/noryx-environments/noryx-workspace-vscode:0.1.0`
