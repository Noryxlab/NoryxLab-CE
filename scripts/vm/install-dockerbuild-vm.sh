...
# Usage:
#   HARBOR_HOSTNAME=harbor.example.local HARBOR_IP=CHANGE_ME ./install-dockerbuild-vm.sh
...
echo "  ./scripts/ops/sync-images-to-harbor.sh"
echo "  CATALOG_FILE=deploy/images/environments-images.txt ./scripts/ops/sync-images-to-harbor.sh"
